...
export function SparklesPreview() {
  ...
  return (
    <div className="h-[40rem] pb-[70px] relative w-full bg-black flex flex-col items-center justify-end overflow-hidden">
      ...
      <h1 className="leading-[3rem] md:text-7xl text-3xl lg:text-6xl font-bold text-center text-white relative z-20">
      ...
      <p className="text-center  text-white text-sm font-thin lg:text-xl mt-5 mx-8" style={{ textShadow: '0 4px 6px rgba(255, 255, 255, 0.5)' }}>
